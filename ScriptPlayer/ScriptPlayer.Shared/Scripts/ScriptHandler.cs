...
namespace ScriptPlayer.Shared.Scripts
{
    public class ScriptHandler
    {
        ...
        private void ExtendRange()
        {
            ...
            int lastValue = _filledActions[0].Position;
            int lastExtremeValue = lastValue;

            int lowest = lastValue;
            int highest = lastValue;
        ...
        private int StretchPosition(int position, int lowest, int highest, int extension)
        {
